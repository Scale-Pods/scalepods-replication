        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            ...
            <p style={{ fontSize: "15px", color: "#B8C7D9", lineHeight: 1.7, marginBottom: "40px" }}>
              Welcome to ScalePods ("we" or "us"). This Terms Of Service is designed to help you understand how we collect, use, disclose, and safeguard your personal information when you use our website and related services.
            </p>
